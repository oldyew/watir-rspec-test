...
# def rspec_exception_interact(node, call, report)
#     allure.attach(
#         name='Screenshot',
#         body=browser.driver().get_screenshot_as_png(),
#         attachment_type=allure.attachment_type.PNG
#     )
#     browser_log = browser.driver().get_log('browser')
#     errors = []
...
#         )
#     id = get_session_id()
#     while not os.path.exists(id + ".mp4"):
#         time.sleep(1)
#     if os.path.isfile(id + ".mp4"):
#         allure.attach.file(id + ".mp4", attachment_type=allure.attachment_type.MP4, name='Video')
...
RSpec.configure do |config|
  ...
  #   @browser = Watir::Browser.new(browser: ENV['browserName'], name: x.full_description, platform: ENV['platform'], version: ENV['version'])
  # end
end
