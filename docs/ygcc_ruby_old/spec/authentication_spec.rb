...
module YoungGuns
  ...
  describe 'User', feature: 'General', severity: :normal, tag: 'End to End' do
    ...
    it 'logins', story: 'Test', severity: :normal, testId: 'https://jira.quartileone.com/browse/YGCC-2290', issue: 'https://jira.quartileone.com/browse/YGCC-1290' do |e|
    ...
    it 'logout', story: 'Test', severity: :normal, testId: 'https://jira.quartileone.com/browse/YGCC-2291', issue: 'https://jira.quartileone.com/browse/YGCC-2291' do |e|
      site.login(user)
    ...
    xit 'Reset password from Login Page', story: 'Test', severity: :normal, testId: 'https://jira.quartileone.com/browse/YGCC-2293', issue: 'https://jira.quartileone.com/browse/YGCC-2293' do |e|
      e.step 'step1' do
        @auth_page.open
        s.attach_file "screenshot1", take_screenshot_as_file
      end
